...
import se.lequest.lequest.maps.CatacombMap;
...
public class TownFrame extends JFrame implements Observer {
    ...
    private JPanel playerInfoButtonPanel, marketButtonPanel, tavernButtonPanel, mapButtonPanel, wisemanButtonPanel;
    private JPanel playerInfoPanel, townImagePanel;
    private JLabel playerInfoHeading, townInfoHeading;
    private JTextArea marketInfoArea, tavernInfoArea, mapInfoArea, wisemanInfoArea, townInfoArea, playerInfoArea, townPositionArea;
    ...
    private void loadPlayer() {
        Player newplayer = FileIO.loadPlayer();
        if (newplayer != null) {
